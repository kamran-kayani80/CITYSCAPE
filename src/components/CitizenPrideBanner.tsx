  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="relative z-10 pt-3 sm:pt-4 grid grid-cols-1 lg:grid-cols-12 gap-4 sm:gap-5 lg:gap-6 items-stretch">
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="space-y-1 sm:space-y-1.5">
                  <span
                    className="block text-[11px] sm:text-xs md:text-sm font-bold uppercase tracking-wider text-white text-[#FFFFFF]"
                    style={{ color: '#FFFFFF' }}
                  >
                    Civic Resident Demonym
                  </span>
                  <h1
                    className="font-extrabold tracking-tight text-xl xs:text-2xl sm:text-3xl md:text-4xl xl:text-5xl leading-tight text-white text-[#FFFFFF] flex flex-wrap items-center gap-1.5 sm:gap-2"
                    style={{ color: '#FFFFFF' }}
                  >
                    <span className="whitespace-nowrap text-white text-[#FFFFFF]" style={{ color: '#FFFFFF' }}>
                      I AM A PROUD
                    </span>
                    <span
                      className="inline-block text-white text-[#FFFFFF] bg-white/20 backdrop-blur-md px-3 sm:px-4 py-0.5 sm:py-1 rounded-xl sm:rounded-2xl border-2 border-white shadow-md"
                      style={{ color: '#FFFFFF' }}
                    >
                      {activeCity.demonym}
                    </span>
                ...
                <div className="p-3 sm:p-4 rounded-2xl bg-white/12 dark:bg-white/8 backdrop-blur-md border border-white/25 shadow-sm space-y-2">
                  <div className="flex items-center justify-between gap-2">
                    ...
                    <button
                      ...
                      className="inline-flex items-center gap-1 px-2.5 py-1 rounded-lg bg-white/15 hover:bg-white/30 text-white text-[11px] font-bold transition-all cursor-pointer border border-white/20 active:scale-95"
                    >
                  ...
                  <div className="pt-2 flex flex-wrap items-center gap-2 border-t border-white/15">
                    <button
                      id="banner-btn-report-problem"
                      type="button"
                      onClick={handleOpenReport}
                      className="inline-flex items-center gap-1.5 px-3.5 py-2 bg-[#B45309] hover:bg-[#92400E] text-white text-xs sm:text-sm font-bold rounded-xl shadow-sm transition-all cursor-pointer border border-amber-300/40"
                    >
                    ...
                    <span className="text-[11px] text-teal-200 font-medium">
                      +50 Civic Karma for every verified report
                    </span>
                  </div>
                </div>
              </motion.div>
