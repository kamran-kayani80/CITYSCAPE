    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 font-['Montserrat']">
        ...
        <div className="p-5 soft-card space-y-2">
          ...
          <p className="text-3xl font-['Montserrat'] font-black text-emerald-700 font-mono">{stats.resolvedCount}</p>
        ...
        <div className="p-5 soft-card space-y-2">
          <div className="flex items-center justify-between">
            <span className="text-xs font-black text-slate-900 dark:text-white">Community Endorsements</span>
            <div className="p-2 icon-tile-violet rounded-xl">
              <ThumbsUp className="w-4 h-4" />
            </div>
          </div>
          <p className="text-3xl font-['Montserrat'] font-black text-purple-800 font-mono">{stats.upvotesTotal}</p>
