...
const PRIMARY_BRAND_COLORS: ColorToken[] = [
  {
    name: 'Evergreen Teal',
    role: 'Main Brand Identifier',
    hex: '#008080',
    rgb: 'RGB: 0, 128, 128',
    cmyk: 'CMYK: 100, 0, 30, 50',
    wcagContrast: '7.4:1 (AAA)',
    description: 'Inspired by the nature we protect and the technology we create. Serves as our main brand anchor.',
    usage: 'Main brand identifier, primary buttons, hero badges, key call-to-actions.',
    category: 'primary'
  },
  {
    name: 'Electric Lime',
    role: 'Accent & Energetic Separator',
    hex: '#CCFF00',
    rgb: 'RGB: 204, 255, 0',
    cmyk: 'CMYK: 20, 0, 100, 0',
    wcagContrast: '14.2:1 (on Slate Black)',
    description: 'High-energy electric lime providing punchy highlights and energetic visual dividers. Use sparingly.',
    usage: 'Highlighting, accents, energetic separators, focused status markers.',
    category: 'primary'
  },
  {
    name: 'Slate Black',
    ...
    rgb: 'RGB: 26, 26, 26',
    cmyk: 'CMYK: 0, 0, 0, 90',
    wcagContrast: '18.5:1 (AAA)',
    description: 'Deep, crisp slate black providing authoritative contrast for text and dark mode backgrounds.',
    usage: 'Body text, main headlines, dark mode containers, high-contrast borders.',
    category: 'primary'
  }
];
...
const SECONDARY_BRAND_COLORS: ColorToken[] = [
  {
    ...
    rgb: 'RGB: 242, 242, 242',
    cmyk: 'CMYK: 0, 0, 0, 5',
    wcagContrast: '16.8:1 (vs Slate Black)',
    description: 'Soft neutral grey supporting complex layouts, subtle grid borders, and glare-free backgrounds.',
    usage: 'Backgrounds, structural card borders, input field outlines, layout dividers.',
    category: 'secondary'
  },
  {
    name: 'Sun Yellow',
    role: 'Data Visualization Accent',
    hex: '#FFD700',
    rgb: 'RGB: 255, 215, 0',
    cmyk: 'CMYK: 0, 15, 100, 0',
    wcagContrast: '11.4:1 (vs Slate Black)',
    description: 'Vibrant golden yellow accent designed to pop in data visualizers, charts, and key progress indicators.',
    usage: 'Data visualization accents, chart elements, progress markers, spotlight badges.',
    category: 'secondary'
  }
];
...
const LEGACY_CIVIC_COLORS: ColorToken[] = [
  {
    name: 'Progressive Blue',
    role: 'Municipal Authority',
    hex: '#2B6CB0',
    rgb: 'RGB: 43, 108, 176',
    cmyk: 'CMYK: 85, 55, 10, 0',
    wcagContrast: '7.8:1 (AAA)',
    description: 'Trust-inspiring medium blue for civic leadership and official infrastructure headers.',
    usage: 'Navigation bars, civic verification badges, public works notices.',
    category: 'legacy'
  },
  {
    name: 'Engaged Coral',
    role: 'Citizen Action CTA',
    hex: '#E06D53',
    rgb: 'RGB: 224, 109, 83',
    cmyk: 'CMYK: 10, 70, 65, 0',
    wcagContrast: '7.1:1 (AAA)',
    description: 'High-energy coral amber driving resident participation and issue reporting.',
    usage: '+ Report buttons, urgent alerts, karma triggers.',
    category: 'legacy'
  }
];
